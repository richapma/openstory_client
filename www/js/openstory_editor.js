...
//***TO DO: rotate needs work to add mouse_up event and need to modify so its not using distance but working out angle between center and where i clicked originally and to the new location.
//***TO DO: rotate and scale function need to be switchable, currently if use scale it breaks rotate.
//Need to add this to auto func: $(_AM.images[image_idx]).trigger("on_selected", { typ: "scene_image", scene_image: _AM.images[image_idx] });

//*** NOTE: to debug, change window.__offline to 1 and include this js file in the editor.html file.
window.__offline = 1;
